...
const TwitterCard = ({ name, handle, comment, linkedin }: TwitterCardProps) => {
  return (
    <div className=" group border border-grey-200 dark:border-[#27272a]  bg-secondary px-10 py-5 rounded-3xl flex flex-col gap-5 hover:bg-blue-400 dark:hover:bg-blue-400 cursor-pointer dark:bg-darkBg relative">
